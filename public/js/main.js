...
anchors.forEach(function ($button) {
  $button.addEventListener('click', function (e) {
    e.preventDefault();
    var $el = document.getElementById($button.getAttribute('href').substring(1));
    if ($el) {
...
function handleMarquee() {
  ...
  marquee.forEach(function (el) {
    ...
    var content = el.querySelector('.inner ul');
    // Get total width
    ...
    function loop() {
      ...
      container.style.transform = "translateX(".concat(progress, "px)");
      container.style.transform += "skewX(".concat(speed * 0.4, "deg)");
...
var arrProductCarousel = document.querySelectorAll('.catalog');
arrProductCarousel.forEach(function ($sCarousel) {
  var $prev = $sCarousel.querySelector('.swiper-button-prev');
  var $next = $sCarousel.querySelector('.swiper-button-next');
  var $carousel = $sCarousel.querySelector('.swiper');
...
// eslint-disable-next-line no-unused-vars
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](document.querySelector('.bottom-carousel  .swiper'), {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_1__.Pagination],
  loop: true,
  slidesPerView: 1,
  spaceBetween: 0,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _s_header_s_header__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./s-header/s-header */ "./src/components/s-header/s-header.js");
/* harmony import */ var _s_header_s_header__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_s_header_s_header__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./src/components/s-header/s-header.js":
/*!*********************************************!*\
  !*** ./src/components/s-header/s-header.js ***!
  \*********************************************/
/***/ (() => {
...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core */ "./src/base/js/core.js");
/* harmony import */ var _vendor_vendor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../vendor/vendor */ "./src/vendor/vendor.js");
/* harmony import */ var _vendor_vendor__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_vendor__WEBPACK_IMPORTED_MODULE_1__);
